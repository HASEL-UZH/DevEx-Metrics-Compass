...
1.  Navigate to the **"metrics"** sheet.
    ...
    * Fill in the metric's name (**column B**), synonyms (**column C**), description (**column F**), type (**column G**), AI specific category (**column P**), Outcome Goals (**column Q**), Ease of Collection (**column R**), and Related Metrics (**column S**).
2.  Assign a category.
